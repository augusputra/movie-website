...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">Movie Website Admin</div>
                </a>
                ...
                <!-- Nav Item - Dashboard -->
                <li class="{{ Request::segment(2) === 'movie' ? 'active' : null }} nav-item" id="menus-sidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="{{ Request::segment(2) === 'trash' ? 'active' : null }} nav-item" id="menus-sidebar">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <footer class="sticky-footer bg-white">
                    ...
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Movie Website 2020</span>
                    </div>
                    </div>
                </footer>
                <!-- End of Footer -->
        ...
        <!-- Page level plugins -->
        <script src="{{URL::to('admin/vendor/datatables/jquery.dataTables.min.js')}}"></script>
        <script src="{{URL::to('admin/vendor/datatables/dataTables.bootstrap4.min.j')}}s"></script>

        <!-- Page level custom scripts -->
        <script src="{{URL::to('admin/js/demo/datatables-demo.js')}}"></script>     
